...
<script src="https://cdnjs.cloudflare.com/ajax/libs/leaflet.draw/1.0.2/leaflet.draw.js"></script>
	...
	"properties": {
	"name": "Almuerzos doña gloria",
     "title": "Almuerzos doña gloria",
	"imagen": "comida.jpeg",}}
	,{
    "type": "Feature",
	"geometry": {
...
for(i=0; i<jsonPHP.length; i++){
	var Layer = L.geoJSON(jsonPHP , {
			pointToLayer: function (feature, latlng) {
return L.marker([jsonPHP[i][0],jsonPHP[i][1]])}}};
*/	
...
console.log(jsonPHP);
for(i=0; i<jsonPHP.length; i++){
var marcadorPHP= L.marker([jsonPHP[i][0],jsonPHP[i][1]]).addTo(map);

marcadorPHP.bindPopup('<h2>cod. '+ jsonPHP[i][2]+"</h2><br> " + jsonPHP[i][3]);}
...
L.easyButton('<img src="reset.png"  align="absmiddle" height="16px" >', function() 
		{
...
L.easyButton('<img src="robo.jpg"  align="absmiddle" height="16px" >', function() 
		{
		
		featuresLayer.addTo(map);
         map.flyTo([3.375486, -76.533336], 14); 
		


		
		leyenda.addOverlay(featuresLayer, 'hurtos');
...
L.easyButton('<img src="dots-chart.png"  align="absmiddle" height="16px" >', function() 
		{	
		
		var heat = L.heatLayer([[featuresLayer._layers[60]._latlng.lat,featuresLayer._layers[60]._latlng.lng,10]],{radius: 50}).addTo(map);
		
		for (var i = 62; i<74; i++){

		heat.addLatLng([featuresLayer._layers[i]._latlng.lat,featuresLayer._layers[i]._latlng.lng,10],{radius: 25});
