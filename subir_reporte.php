...
$sql2 ="INSERT INTO hurtos(nombre, apellidos, tipo_doc, numero_doc, sexo, direccion, barrio, fecha_hurto, modo_del, modalidad, descripcion, denuncia, edad, id_comuna, id_barrio, geom, latitud, longitud) VALUES('$R_Nombre_Digitado','$R_Apellidos_Digitado', '$R_Tipo_Documento','$R_Nro_Doc_Digitado','$R_Sexo_Digitado','$R_Direccion_Digitado','$R_Barrios_Digitado','$R_Fecha_digitado','$R_Delito_Digitado','$R_Modalidad_Digitado','$R_Descripcion_digitado','$R_Denuncia','$R_Edad_Digitado','$GIDC','$GIDB',ST_GeomFromText('POINT($R_Lngi $R_Lati)', 4326),'$R_Lati','$R_Lngi');"; // Ingreso de registro en SQL (parametros de usuario)
